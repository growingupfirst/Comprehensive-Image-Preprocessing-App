...
#---HEADLINE---
st.markdown("""## Comprehensive Image Preprocessing App 🚀
...
# st.markdown("---")
# st.markdown("<h2 style='text-align: center;'> Comprehensive Image Preprocessing Tool </h2>", unsafe_allow_html=True)
# st.write('Hello. Choose tool at the right')
